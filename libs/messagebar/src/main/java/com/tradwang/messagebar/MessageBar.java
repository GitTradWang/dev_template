...
public final class MessageBar {
    ...
    private void showView() {
        ...
        if (ViewCompat.isLaidOut(mView)) {
            ...
            mView.setOnTouchEventListener(new MessageBarLayout.OnTouchEventListener() {
                @Override
    ...
    final class Behavior extends SwipeDismissBehavior<MessageBarLayout> {
        ...
        @Override
        public boolean onInterceptTouchEvent(CoordinatorLayout parent, @NotNull MessageBarLayout child, MotionEvent event) {
