package com.tradwang.datepicker.time;
...
import com.tradwang.datepicker.R;
...
public class HourAndMinutePicker extends LinearLayout implements
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        int textSize = a.getDimensionPixelSize(R.styleable.HourAndMinutePicker_itemTextSize, getResources().getDimensionPixelSize(R.dimen.WheelItemTextSize));
        int textColor = a.getColor(R.styleable.HourAndMinutePicker_itemTextColor, Color.BLACK);
        ...
        int selectedItemTextColor = a.getColor(R.styleable.HourAndMinutePicker_selectedTextColor, getResources().getColor(R.color.com_ycuwq_datepicker_selectedTextColor));
        ...
        int itemWidthSpace = a.getDimensionPixelSize(R.styleable.HourAndMinutePicker_itemWidthSpace, getResources().getDimensionPixelOffset(R.dimen.WheelItemWidthSpace));
        int itemHeightSpace = a.getDimensionPixelSize(R.styleable.HourAndMinutePicker_itemHeightSpace, getResources().getDimensionPixelOffset(R.dimen.WheelItemHeightSpace));
